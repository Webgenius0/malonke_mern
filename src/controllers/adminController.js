...
export const createAdmin = catchAsync(async (req, res, next) => {
    ...
    const {username, firstName, lastName,phone, email, password, confirmPassword, isTermAgree} = req.body;

    // Check required fields
    if (!username || !firstName || !lastName || !phone || !email || !password || !confirmPassword || !isTermAgree) {
